"""
Path translation for FlowForge Pi→Mac architecture.

When FlowForge runs on a Raspberry Pi but git repos live on Mac,
...
class PathTranslator:
    ...
    Passthrough mode:
        ...
        This supports running FlowForge directly on Mac (local development).
    """
    ...
    def to_relative(self, full_path: str) -> str:
        ...
        Returns:
            Relative path (e.g., "AirFit/.flowforge-worktrees/dark-mode")
        """
...
def create_path_translator() -> PathTranslator:
    ...
    Reads:
        FLOWFORGE_PROJECTS_PATH - Pi-native base path
        FLOWFORGE_MAC_PROJECTS_PATH - Mac base path (for SSH)

    Returns:
        Configured PathTranslator
    """
    pi_base = os.environ.get("FLOWFORGE_PROJECTS_PATH")
    mac_base = os.environ.get("FLOWFORGE_MAC_PROJECTS_PATH")
